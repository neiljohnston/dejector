...
from dejector.core import DejectorScanner, ScanVerdict, PROFILES
...
def scan_command(args):
    ...
    if args.profile:
        from dejector.core import PROFILES
...
def install_command(args):
    ...
    from dejector.install import install_skill
...
def gmail_command(args):
    ...
    from dejector.gmail import detect_cli, scan_emails
...
def main():
    ...
    test_parser.add_argument("--profile", choices=list(PROFILES.keys()))
